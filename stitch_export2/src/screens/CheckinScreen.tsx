...
export const CheckinScreen: React.FC<CheckinScreenProps> = ({
  ...
  const [currentStep, setCurrentStep] = useState(1); // 0-indexed: question 2 is index 1
  ...
  return (
    <div className="min-h-[calc(100vh-45px)] w-full flex flex-col items-center justify-between p-4 sm:p-6 bg-[#FCF8F9] text-[#1C1B1C] animate-fade-in relative">
      {/* Top Header */}
